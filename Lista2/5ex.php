...
<html lang="en">
  ...
  <body>
  <form method="post" class="container mt-5" action="5resp.php">
                        
                        <div class="mb-3 col-md-2">
                            <label for="num1" class="form-label ">Primeiro numero</label>
                        ...
                        <div class="mb-3 col-md-2">
                            <label for="num3" class="form-label ">Terceiro numero</label>
